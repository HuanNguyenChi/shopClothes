    ...
    <div id="layoutSidenav_content" >
        <main>
            <div class="container-fluid px-4">
                ...
                <form th:action="@{/admin/addproduct}" th:object="${productForm}" method="post" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        ...
        //     var data_form = $('#form-product').serializeArray();
        ...
        //         if (field.name == 'size') {
        //             size.push(field.value);
        //             // size = size + field.value + " ";
        //         }else if(field.name == 'color'){
        //             color.push(field.value);
